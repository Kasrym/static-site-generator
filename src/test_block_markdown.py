...
"""
    ...
    def test_code(self):
        ...
        self.assertEqual(block_to_block_type("```not closed"), BlockType.PARAGRAPH)
    ...
    def test_ordered_list(self):
        ...
        # Invalid sequence (skipped a number)
    ...
    def test_paragraph(self):
        self.assertEqual(block_to_block_type("Just a normal paragraph of text."), BlockType.PARAGRAPH)
